function  validation(frm){
  ...
  else if(ename.length>20){   //ename -max length rule
	   document.getElementById("enameErr").innerHTML="employee name must have max of 20 chars(cs)";
       flag=false;
    }
  ...
  else if(job.length>15){  //job -max length rule
	   document.getElementById("jobErr").innerHTML="employee desg  can hav max 15 characters(cs)";
     flag=false;  
  }
